...
class DockTilePlugin: NSObject, NSDockTilePlugIn {
    ...
    #if DEBUG
    private let ghosttyUserDefaults = UserDefaults(suiteName: "com.paaloeye.ghostty.debug")
    #else
    private let ghosttyUserDefaults = UserDefaults(suiteName: "com.paaloeye.ghostty")
    #endif
